      ...
      <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded)=> handleChange(isExpanded, 'panel1')}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            explicabo omnis facilis natus ipsum quaerat, itaque dolor
            accusantium doloribus at, ab molestias laudantium laborum. Quas
            fugit dignissimos libero modi nobis.
          </Typography>
        </AccordionDetails>
      </Accordion>
